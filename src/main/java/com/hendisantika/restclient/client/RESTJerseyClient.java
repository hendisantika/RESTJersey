...
public class RESTJerseyClient {
    ...
    private void getFtoCResponse() {
        try {
            ...
            WebResource webResource2 = client.resource("http://localhost:8084/RestClient/crunchify/ftocservice/90");
    ...
    private void getCtoFResponse() {
        try {
            ...
            Client client = Client.create();
            WebResource webResource = client.resource("http://localhost:8084/RestClient/crunchify/ctofservice/40");
